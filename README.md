...
- Built upon [OpenCode](https://github.com/cliffc2/opencode) (fork)
- Built upon [OpenSage](https://github.com/cliffc2/opensage) (fork)
- Uses [litellm](https://github.com/BerriAI/litellm) for LLM abstraction
- Uses [Neo4j](https://neo4j.com/) for persistent graph storage
- Generated by free AI models: Opencode, Minimax 2.5 Free, Nemotron 3 Super Free, audited by Cursor and Docker free tier.
